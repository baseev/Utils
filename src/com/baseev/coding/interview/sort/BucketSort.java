...
class BucketSort
{
    ...
    /**
     * test program for bucketsort; reads arbitrarily-many numbers from standard
     * input, sorts them, then writes them to standard output.
     **/
    ...
    /**
     * reallocate allocates a new array int the size of the original and copies
     * the original into it. The new array is returned.
     **/
